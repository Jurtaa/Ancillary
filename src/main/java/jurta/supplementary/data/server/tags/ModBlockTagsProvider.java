...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(BlockTags.STAIRS).add(ModBlocks.ROCK_STAIRS.get(), ModBlocks.POLISHED_ROCK_STAIRS.get());
        tag(BlockTags.WOODEN_SLABS).add(ModBlocks.SAKURA_SLAB.get());
        tag(BlockTags.SLABS).add(ModBlocks.ROCK_SLAB.get(), ModBlocks.POLISHED_ROCK_SLAB.get());
        ...
        tag(BlockTags.WALLS).add(ModBlocks.ROCK_WALL.get(), ModBlocks.POLISHED_ROCK_WALL.get());
        // Forge Tags
