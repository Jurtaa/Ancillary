...
public class RockBlock extends Block implements IWaterLoggable {
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
    protected static final VoxelShape SHAPE = VoxelShapes.or(
        Block.box(12.0D, 0.0D, 12.0D, 13.0D, 1.0D, 13.0D),
        Block.box(4.0D, 0.0D, 4.0D, 12.0D, 7.0D, 12.0D),
        Block.box(3.0D, 0.0D, 11.0D, 5.0D, 2.0D, 13.0D),
        Block.box(7.0D, 0.0D, 3.0D, 8.0D, 1.0D, 4.0D)
    );
