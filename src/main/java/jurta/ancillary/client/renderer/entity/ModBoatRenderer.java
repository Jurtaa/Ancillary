package jurta.ancillary.client.renderer.entity;
...
public class ModBoatRenderer extends EntityRenderer<ModBoatEntity> {
    private static final ResourceLocation[] BOAT_TEXTURE_LOCATIONS = new ResourceLocation[]{new ResourceLocation(Ancillary.MOD_ID, "textures/entity/boat/sakura.png")};
