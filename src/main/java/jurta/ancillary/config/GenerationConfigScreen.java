...
public class GenerationConfigScreen extends Screen {
    ...
    public GenerationConfigScreen(Screen parentScreen) {
        ...
        super(new TranslationTextComponent("config.ancillary.generation.title", Ancillary.MOD_ID));
    ...
    protected void init() {
        ...
        this.optionsRowList.addSmall(new BooleanOption(
                "config.ancillary.allowVegetalGeneration.title",
                new TranslationTextComponent("config.ancillary.allowVegetalGeneration.tooltip", Ancillary.MOD_ID),
